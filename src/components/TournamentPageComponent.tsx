...
export default function TournamentPageComponent({ tournamentId }: { tournamentId: string }) {
                    ...
                    <ul className="flex flex-nowrap justify-start sm:justify-center gap-4 sm:gap-8 text-sm font-semibold text-[#9CA3AF] border-b border-[#1F2430] w-fit mx-auto">
                        {tabs.map((tab) => (
                            <li
                                ...
                                className={`relative pb-2 cursor-pointer transition-all whitespace-nowrap ${activeTab === tab
